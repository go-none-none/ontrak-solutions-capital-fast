    ...
    <div className="space-y-6 overflow-hidden">
      <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-4 sm:p-6 shadow-lg text-white overflow-hidden">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-4">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3 min-w-0"><p className="text-orange-100 text-xs mb-1 truncate">Periods</p><p className="text-lg sm:text-2xl font-bold truncate">{stats.totalStatements}</p></div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3 min-w-0"><p className="text-orange-100 text-xs mb-1 truncate">Avg Balance</p><p className="text-sm sm:text-lg font-bold truncate">{formatCurrency(stats.avgDailyBalance)}</p></div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-2 sm:p-3 min-w-0"><p className="text-orange-100 text-xs mb-1 truncate">Total Deposits</p><p className="text-sm sm:text-lg font-bold truncate">{formatCurrency(stats.totalDeposits)}</p></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="bg-white rounded-2xl p-3 sm:p-5 shadow-md hover:shadow-lg transition-shadow border border-slate-200 min-w-0">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="p-1.5 sm:p-2 bg-green-100 rounded-xl flex-shrink-0"><TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-green-600" /></div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-5 shadow-md hover:shadow-lg transition-shadow border border-slate-200 min-w-0">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="p-1.5 sm:p-2 bg-red-100 rounded-xl flex-shrink-0"><TrendingDown className="w-4 h-4 sm:w-5 sm:h-5 text-red-600" /></div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-5 shadow-md hover:shadow-lg transition-shadow border border-slate-200 min-w-0">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="p-1.5 sm:p-2 bg-purple-100 rounded-xl flex-shrink-0"><AlertTriangle className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" /></div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-5 shadow-md hover:shadow-lg transition-shadow border border-slate-200 min-w-0">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="p-1.5 sm:p-2 bg-amber-100 rounded-xl flex-shrink-0"><Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600" /></div>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-md border border-slate-200 overflow-hidden">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="p-3 sm:p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200 min-w-0"><div className="flex items-center gap-2 mb-2"><CreditCard className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600 flex-shrink-0" /><p className="text-xs text-blue-700 font-medium truncate">Total Transactions</p></div><p className="text-xl sm:text-2xl font-bold text-blue-900 truncate">{stats.totalTransactions.toFixed(0)}</p></div>
          <div className="p-3 sm:p-4 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl border border-emerald-200 min-w-0"><div className="flex items-center gap-2 mb-2"><DollarSign className="w-3 h-3 sm:w-4 sm:h-4 text-emerald-600 flex-shrink-0" /><p className="text-xs text-emerald-700 font-medium truncate">Total Deposits</p></div><p className="text-xl sm:text-2xl font-bold text-emerald-900 truncate">{formatCurrency(stats.totalDeposits)}</p></div>
          <div className="p-3 sm:p-4 bg-gradient-to-br from-rose-50 to-rose-100 rounded-xl border border-rose-200 min-w-0"><div className="flex items-center gap-2 mb-2"><TrendingDown className="w-3 h-3 sm:w-4 sm:h-4 text-rose-600 flex-shrink-0" /><p className="text-xs text-rose-700 font-medium truncate">Total Withdrawals</p></div><p className="text-xl sm:text-2xl font-bold text-rose-900 truncate">{formatCurrency(stats.totalWithdrawals)}</p></div>
          <div className="p-3 sm:p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl border border-indigo-200 min-w-0"><div className="flex items-center gap-2 mb-2"><BarChart3 className="w-3 h-3 sm:w-4 sm:h-4 text-indigo-600 flex-shrink-0" /><p className="text-xs text-indigo-700 font-medium truncate">Net Cash Flow</p></div><p className="text-xl sm:text-2xl font-bold text-indigo-900 truncate">{formatCurrency(stats.totalDeposits - stats.totalWithdrawals)}</p></div>
        </div>
      </div>
          ...
          <div className="min-w-[300px]">
            <ResponsiveContainer width="100%" height={280}>
              <LineChart data={timelineData}>
                ...
                <Legend />
                <Line type="monotone" dataKey="balance" stroke="#f59e0b" strokeWidth={3} name="Avg Daily Balance" dot={{ fill: '#f59e0b', r: 4 }} activeDot={{ r: 6 }} fill="url(#balanceGradient)" />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>

...
<head>
    ...
    <title>Urgent - Contracts Need Signature</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; font-size: 28px; font-weight: bold; margin: 0; line-height: 1.3;">⚠️ Action Required</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                It's been 48 hours and your contracts still need your signature. I don't want you to miss out on your approved funding!
                            </p>

                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 20px 0;">
                                <tr>
                                    <td style="padding: 20px; background-color: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px;">
                                        <p style="color: #92400e; font-size: 15px; font-weight: 600; margin: 0 0 8px 0;">⏰ Time Sensitive</p>
                                        <p style="color: #78350f; font-size: 14px; line-height: 1.6; margin: 0;">
                                            Your approval is time-limited. Please sign as soon as possible to secure your funding terms.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 10px 0;">
                                        <a href="{!Opportunity.Contract_Link__c}" style="display: inline-block; background: linear-gradient(to right, #f59e0b, #d97706); color: #ffffff; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 40px; border-radius: 30px; box-shadow: 0 4px 6px rgba(245, 158, 11, 0.3);">
                                            Sign Contracts Now
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding: 10px 0;">
                                        <a href="tel:{!Owner.Phone}" style="display: inline-block; background-color: #ffffff; color: #f59e0b; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 30px; border: 2px solid #f59e0b;">
                                            Call Me: {!Owner.Phone}
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 20px 0;">
                                <tr>
                                    <td style="padding: 20px; background-color: #fef3c7; border-radius: 12px;">
                                        <p style="color: #92400e; font-size: 15px; font-weight: 600; margin: 0 0 10px 0;">⚠️ Concerns or Questions?</p>
                                        <p style="color: #78350f; font-size: 14px; line-height: 1.6; margin: 0;">
                                            Call me immediately — I'm here to help!<br>
                                            <a href="tel:{!Owner.Phone}" style="color: #92400e; text-decoration: none; font-weight: 600;">{!Owner.Phone}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>

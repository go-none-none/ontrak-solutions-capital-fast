...
<head>
    ...
    <title>Congratulations - You're Funded!</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #08708E 0%, #065a72 50%, #1e293b 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; font-size: 28px; font-weight: bold; margin: 0; line-height: 1.3;">Congratulations - You're Funded!</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="color: #0f172a; font-size: 18px; margin: 0 0 20px 0; font-weight: 600;">Hi {!Opportunity.FirstName__c},</p>
                            
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                Congratulations! Your funding has been successfully processed. Thank you for choosing OnTrak Solutions - we're excited to be part of your business journey!
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #f0f9ff 0%, #dbeafe 100%); border-left: 4px solid #08708E; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="color: #08708E; font-size: 14px; font-weight: 600; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.5px;">🎉 Success!</p>
                                        <p style="color: #0f172a; font-size: 15px; margin: 0;">Your funds have been sent. Check your account for confirmation and feel free to reach out anytime!</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                If you need additional funding in the future or have any questions, don't hesitate to contact me. I'm here to help your business succeed!
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 15px; background-color: #f8fafc; border-left: 4px solid #08708E; border-radius: 8px; margin-bottom: 10px;">
                                        <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0 0 10px 0; font-style: italic;">
                                            "The funding helped me hire two new employees. My business is thriving now!"
                                        </p>
                                        <p style="color: #0f172a; font-size: 13px; font-weight: 600; margin: 0;">— Gregory N., Marketing Agency</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px; background-color: #f8fafc; border-left: 4px solid #08708E; border-radius: 8px;">
                                        <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0 0 10px 0; font-style: italic;">
                                            "Simple process, fair terms, and lightning fast. I'll definitely use OnTrak again!"
                                        </p>
                                        <p style="color: #0f172a; font-size: 13px; font-weight: 600; margin: 0;">— Michelle S., Coffee Shop</p>
                                    </td>
                                </tr>
                            </table>

...
<head>
    ...
    <title>One Week Later - Let's Talk</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #08708E 0%, #065a72 50%, #1e293b 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; font-size: 28px; font-weight: bold; margin: 0; line-height: 1.3;">One Week Later - Let's Talk</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                It's been a week since we sent your application. I just wanted to check in and see if there's anything standing in your way.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #f0f9ff 0%, #dbeafe 100%); border-left: 4px solid #08708E; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        <p style="color: #08708E; font-size: 14px; font-weight: 600; margin: 0 0 8px 0; text-transform: uppercase; letter-spacing: 0.5px;">📞 Let's Connect</p>
                                        <p style="color: #0f172a; font-size: 15px; margin: 0;">Sometimes a quick conversation is all it takes. Give me a call and let's discuss your funding needs!</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                Whether you're ready to complete your application or just want to talk through your options, I'm here for you. Let's make this happen!
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 15px; background-color: #f8fafc; border-left: 4px solid #08708E; border-radius: 8px; margin-bottom: 10px;">
                                        <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0 0 10px 0; font-style: italic;">
                                            "The team answered all my questions patiently. Made me feel confident throughout!"
                                        </p>
                                        <p style="color: #0f172a; font-size: 13px; font-weight: 600; margin: 0;">— Brandon E., Landscaping Service</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 15px; background-color: #f8fafc; border-left: 4px solid #08708E; border-radius: 8px;">
                                        <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0 0 10px 0; font-style: italic;">
                                            "Transparent pricing and no hidden fees. OnTrak is the real deal!"
                                        </p>
                                        <p style="color: #0f172a; font-size: 13px; font-weight: 600; margin: 0;">— Hannah R., Spa & Wellness</p>
                                    </td>
                                </tr>
                            </table>

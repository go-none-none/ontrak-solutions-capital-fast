...
<head>
    ...
    <title>Still Need Your Signature</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                I wanted to follow up on your contracts. You're so close to receiving your funding — just need your signature!
                            </p>

                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                Once signed, we'll process your funding and have it to you as quickly as possible.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0 0 20px 0;">
                                <tr>
                                    <td style="padding: 20px; background-color: #f0f9ff; border-radius: 12px;">
                                        <p style="color: #0f172a; font-size: 15px; font-weight: 600; margin: 0 0 10px 0;">💬 Questions About the Contracts?</p>
                                        <p style="color: #64748b; font-size: 14px; line-height: 1.6; margin: 0;">
                                            I'm here to help! Call or text me:<br>

                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                Your application is all set and ready for you! It takes just 5-10 minutes to complete. Click the link below whenever you're ready.
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #f0f9ff 0%, #dbeafe 100%); border-left: 4px solid #08708E; border-radius: 8px; margin: 30px 0;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <p style="color: #0f172a; font-size: 15px; margin: 0;">Complete your application and get approved fast. Most applications are reviewed within 24 hours.</p>
                                    </td>
                                </tr>
                            </table>

                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                If you have any questions while filling it out, don't hesitate to reach out. I'm here to help!
                            </p>

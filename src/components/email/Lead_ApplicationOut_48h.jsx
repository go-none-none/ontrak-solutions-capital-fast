                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="center" style="padding: 10px 0;">
                                        <a href="tel:{!Owner.Phone}" style="display: inline-block; background-color: #ffffff; color: #08708E; font-size: 15px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 30px; border: 2px solid #08708E;">
                                            Call Me: {!Owner.Phone}
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #64748b; font-size: 15px; line-height: 1.6; margin: 0;">
                                I'm here whenever you're ready to move forward. Just reply to this email or give me a call.
                            </p>
                        </td>
                    </tr>

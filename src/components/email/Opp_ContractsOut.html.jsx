                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 15px; line-height: 1.6; margin: 0;">
                                <strong style="color: #0f172a;">Questions about your contracts?</strong><br>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="display: inline-block;">
                                            <tr>
                                                <td style="padding: 0 10px;">
                                                   <a href="https://ontrak.co/Status?rid={!Opportunity.Id}" style="color: #64748b; text-decoration: none; font-size: 14px; font-weight: 500;">Sign Contracts</a>
                                                </td>

...
<head>
    ...
    <title>Quick Reminder - Application Ready</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                                Just a quick reminder that your application is ready to complete. It only takes a few minutes!
                            </p>

                            <p style="color: #64748b; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                                The sooner you submit it, the sooner we can get you approved and funded.
                            </p>
                            ...
                            <p style="color: #64748b; font-size: 15px; line-height: 1.6; margin: 0;">
                                ...
                                Contact me at <a href="tel:{!Owner.Phone}" style="color: #08708E; text-decoration: none; font-weight: 600;">{!Owner.Phone}</a>
                            </p>
                        </td>
                    </tr>

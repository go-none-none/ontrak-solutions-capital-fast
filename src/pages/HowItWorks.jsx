...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="relative pt-32 pb-24 bg-gradient-to-br from-[#08708E] via-[#065a72] to-slate-900 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-white/70 mb-8">
                We've designed our funding process to be quick, transparent, and hassle-free, so you can focus on what matters most – your business.
              </p>
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 120" fill="none" className="w-full" style={{ display: 'block' }}>
            <path d="M0 120L60 110C120 100 240 80 360 70C480 60 600 60 720 65C840 70 960 80 1080 85C1200 90 1320 90 1380 90L1440 90V120H0Z" fill="white" stroke="none"/>
          </svg>
        </div>
      </section>

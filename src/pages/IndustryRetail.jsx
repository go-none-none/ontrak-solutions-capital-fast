...
import { ShoppingCart, ArrowRight, CheckCircle, DollarSign, Clock, TrendingUp, Users, Shield, Zap, ThumbsUp } from 'lucide-react';

export default function IndustryRetail() {
  const benefits = [
    { icon: DollarSign, title: 'Inventory Financing', description: 'Stock up for peak seasons or expand product lines' },
    { icon: TrendingUp, title: 'Store Renovations', description: 'Modernize your space to attract more customers' },
    { icon: Users, title: 'Marketing Campaigns', description: 'Launch promotions and boost brand awareness' },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Stock inventory, renovate your store, or launch marketing campaigns to boost sales with tailored retail funding solutions.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">
              How We Help Retail Businesses Thrive
            </h2>
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              From boutique shops to large retailers, we provide flexible funding to help you grow and compete.
            </p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Here's how retail owners are using our funding to grow their business
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Seasonal Inventory', description: 'Stock up for Black Friday, holidays, back-to-school, and other peak seasons' },
              { title: 'Store Renovations', description: 'Update fixtures, lighting, flooring, window displays, and create an inviting atmosphere' },
              { title: 'E-commerce Integration', description: 'Build or upgrade your online store, integrate POS systems, and expand digital presence' },
              { title: 'Product Line Expansion', description: 'Add new product categories, test new brands, and diversify your offerings' },
              { title: 'Marketing Campaigns', description: 'Run social media ads, local promotions, grand reopening events, and loyalty programs' },
              { title: 'Technology Upgrades', description: 'Modern POS systems, inventory management software, and customer analytics tools' }
            ].map((useCase, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-6">
                Why Retail Owners Trust OnTrak
              </h2>
              <div className="space-y-6">
                {[
                  { icon: Zap, title: 'Fast Funding', description: 'Get approved in hours, funded within 24-48 hours - perfect for seasonal opportunities' },
                  ...
                  { icon: ThumbsUp, title: 'Flexible Terms', description: 'Repayment schedules that work with your retail cash flow and seasonal variations' },
                  { icon: CheckCircle, title: 'High Approval Rate', description: 'We work with retail businesses of all sizes and credit profiles - 95% approval rate' }
                ].map((item, i) => (

...
import { Truck, ArrowRight, CheckCircle, DollarSign, Clock, TrendingUp, Users } from 'lucide-react';
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              ...
              <div className="flex items-center gap-2 text-white/90">
                ...
                <span className="font-medium">$100K - $500K Available</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 mb-8">
              Get the capital you need to grow your transportation business and increase revenue.
            </p>
            <Link to={createPageUrl('application')}>

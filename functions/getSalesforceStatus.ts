    ...
    try {
        ...
        if (leadResponse.ok) {
            ...
            return Response.json({
                ...
                email: lead.Email || '',
                csbs__Social_Security_Number_Unencrypted__c: lead.csbs__Social_Security_Number_Unencrypted__c || null,
                csbs__Birthdate__c: lead.csbs__Birthdate__c || null,
                csbs__Federal_Tax_ID_Unencrypted__c: lead.csbs__Federal_Tax_ID_Unencrypted__c || null,
                ownerName: ownerName,
